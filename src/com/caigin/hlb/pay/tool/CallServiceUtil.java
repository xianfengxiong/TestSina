...
public class CallServiceUtil {
   ...
   * 
   * @param url 发送请求的URL
   * @param queryString 请求参数，请求参数应该是 name1=value1&name2=value2 的形式。
  ...
  public static String sendGet(String url, String queryString) {
    ...
    try {
      String urlNameString = url + "?" + queryString;
   ...
   * @throws Exception
   */
  public static String post(Map<String, String> singled, String url, String charset) throws Exception {
